...
public final class PatientMonitoringServiceGrpc {
  ...
  public static final String SERVICE_NAME = "ds.service1.PatientMonitoringService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<ds.service1.PatientMonitoring.RequestMessage,
      ds.service1.PatientMonitoring.ResponseMessage> getMonitorVitalSignsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MonitorVitalSigns",
      requestType = ds.service1.PatientMonitoring.RequestMessage.class,
      responseType = ds.service1.PatientMonitoring.ResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ds.service1.PatientMonitoring.RequestMessage,
      ds.service1.PatientMonitoring.ResponseMessage> getMonitorVitalSignsMethod() {
    io.grpc.MethodDescriptor<ds.service1.PatientMonitoring.RequestMessage, ds.service1.PatientMonitoring.ResponseMessage> getMonitorVitalSignsMethod;
      ...
      synchronized (PatientMonitoringServiceGrpc.class) {
        if ((getMonitorVitalSignsMethod = PatientMonitoringServiceGrpc.getMonitorVitalSignsMethod) == null) {
          PatientMonitoringServiceGrpc.getMonitorVitalSignsMethod = getMonitorVitalSignsMethod =
              io.grpc.MethodDescriptor.<ds.service1.PatientMonitoring.RequestMessage, ds.service1.PatientMonitoring.ResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MonitorVitalSigns"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ds.service1.PatientMonitoring.RequestMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ds.service1.PatientMonitoring.ResponseMessage.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<ds.service1.PatientMonitoring.AlertRequestMessage,
      ds.service1.PatientMonitoring.AlertResponseMessage> getAlertNurseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AlertNurse",
      requestType = ds.service1.PatientMonitoring.AlertRequestMessage.class,
      responseType = ds.service1.PatientMonitoring.AlertResponseMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ds.service1.PatientMonitoring.AlertRequestMessage,
      ds.service1.PatientMonitoring.AlertResponseMessage> getAlertNurseMethod() {
    io.grpc.MethodDescriptor<ds.service1.PatientMonitoring.AlertRequestMessage, ds.service1.PatientMonitoring.AlertResponseMessage> getAlertNurseMethod;
      ...
      synchronized (PatientMonitoringServiceGrpc.class) {
        if ((getAlertNurseMethod = PatientMonitoringServiceGrpc.getAlertNurseMethod) == null) {
          PatientMonitoringServiceGrpc.getAlertNurseMethod = getAlertNurseMethod =
              io.grpc.MethodDescriptor.<ds.service1.PatientMonitoring.AlertRequestMessage, ds.service1.PatientMonitoring.AlertResponseMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AlertNurse"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ds.service1.PatientMonitoring.AlertRequestMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ds.service1.PatientMonitoring.AlertResponseMessage.getDefaultInstance()))
  ...
  public static abstract class PatientMonitoringServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void monitorVitalSigns(ds.service1.PatientMonitoring.RequestMessage request,
        io.grpc.stub.StreamObserver<ds.service1.PatientMonitoring.ResponseMessage> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getMonitorVitalSignsMethod(), responseObserver);
    }

    /**
     */
    public void alertNurse(ds.service1.PatientMonitoring.AlertRequestMessage request,
        io.grpc.stub.StreamObserver<ds.service1.PatientMonitoring.AlertResponseMessage> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ds.service1.PatientMonitoring.RequestMessage,
                ds.service1.PatientMonitoring.ResponseMessage>(
                  this, METHODID_MONITOR_VITAL_SIGNS)))
          .addMethod(
            getAlertNurseMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ds.service1.PatientMonitoring.AlertRequestMessage,
                ds.service1.PatientMonitoring.AlertResponseMessage>(
  ...
  public static final class PatientMonitoringServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PatientMonitoringServiceBlockingStub> {
    ...
    /**
     */
    public ds.service1.PatientMonitoring.ResponseMessage monitorVitalSigns(ds.service1.PatientMonitoring.RequestMessage request) {
    ...
    /**
     */
    public ds.service1.PatientMonitoring.AlertResponseMessage alertNurse(ds.service1.PatientMonitoring.AlertRequestMessage request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class PatientMonitoringServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PatientMonitoringServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ds.service1.PatientMonitoring.ResponseMessage> monitorVitalSigns(
        ds.service1.PatientMonitoring.RequestMessage request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ds.service1.PatientMonitoring.AlertResponseMessage> alertNurse(
        ds.service1.PatientMonitoring.AlertRequestMessage request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MONITOR_VITAL_SIGNS:
          serviceImpl.monitorVitalSigns((ds.service1.PatientMonitoring.RequestMessage) request,
              (io.grpc.stub.StreamObserver<ds.service1.PatientMonitoring.ResponseMessage>) responseObserver);
          break;
        case METHODID_ALERT_NURSE:
          serviceImpl.alertNurse((ds.service1.PatientMonitoring.AlertRequestMessage) request,
              (io.grpc.stub.StreamObserver<ds.service1.PatientMonitoring.AlertResponseMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class PatientMonitoringServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ds.service1.PatientMonitoring.getDescriptor();
    }
